...
function Row({
  ...
  return (
    <div
      ...
      style={{ height: 48, borderBottom: last ? "none" : `1px solid ${t.divider}` }}
    >
...
export default function Settings() {
  ...
  return (
    <div className="flex flex-col flex-1 overflow-hidden page-pop" style={{ backgroundColor: t.bgContent }}>
      ...
      >
        <div
          className="w-full flex items-center gap-[6px] rounded-none p-[5px]"
          style={{ backgroundColor: t.rowBg, border: `1px solid ${t.divider}` }}
        >
          {TABS.map((tab) => {
          ...
          <div className="ml-auto flex items-center">
            <span className="text-[10px]" style={{ color: t.textMuted }}>{APP_VERSION}-alpha</span>
          </div>
        </div>
      </div>
