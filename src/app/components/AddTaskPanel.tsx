              ...
              {isResolumeCompositionChange ? (
                ...
                <>
                  ...
                  <Field label="Request Type">
                    <input
                      style={{ ...INPUT_STYLE, color: P.muted500 }}
                      value={OBS_SCENE_FUNCTION_TO_REQUEST[funcName] ?? ""}
                      readOnly
                    />
                  </Field>
        ...
        {isWorkspace ? (
          <div className="flex items-center justify-between px-[14px] py-[12px]" style={{ backgroundColor: P.surface900 }}>
            ...
            <div className="flex items-center gap-[6px]">
              ...
              <button
                className={`flex items-center justify-center hover:bg-[rgba(255,255,255,0.05)] transition-colors rounded ${ACTION_CLOSE_HOVER_OUTLINE_CLASS}`}
                data-haptic="strong"
                style={{
                  height: PANEL_BUTTON_HEIGHT,
                  padding: "0 14px",
