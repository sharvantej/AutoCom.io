...
export const MOCK_CONNECTIONS: Connection[] = [
  { id: 1, name: "vMix",           ip: "192.168.2.150", port: "8099", protocol: "TCP API",   device: "vMix",           path: "", active: true },
  { id: 2, name: "OBS Studio",     ip: "192.168.2.175", port: "4455", protocol: "WebSocket", device: "OBS Studio",     path: "", active: true },
  { id: 3, name: "Resolume Arena", ip: "192.168.2.195", port: "7000", protocol: "OSC",       device: "Resolume Arena", path: "", active: true },
];
